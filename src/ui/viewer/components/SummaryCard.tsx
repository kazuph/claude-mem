...
export function SummaryCard({ summary }: SummaryCardProps) {
  ...
  const sections = [
    { key: "investigated", label: "調査内容", content: summary.investigated, icon: "/icon-thick-investigated.svg" },
    { key: "learned", label: "学んだこと", content: summary.learned, icon: "/icon-thick-learned.svg" },
    { key: "completed", label: "完了事項", content: summary.completed, icon: "/icon-thick-completed.svg" },
    { key: "next_steps", label: "次のステップ", content: summary.next_steps, icon: "/icon-thick-next-steps.svg" },
    ...
    <article className="card summary-card">
      <header className="summary-card-header">
        <div className="summary-badge-row">
          <span className="card-type summary-badge">セッションサマリー</span>
